...
class _StatistiquesState extends State<Statistiques> {
  late Future<List<double>> _futureData,
      _futureDataMonthly,
      _getDataMonth,
      _year;
            ...
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                return BarChartSample(
                    width: 7,
                    lesX: [
                      getWeekday(weekDaysVal[0]),
                      getWeekday(weekDaysVal[1]),
                      getWeekday(weekDaysVal[2]),
                      getWeekday(weekDaysVal[3]),
                      getWeekday(weekDaysVal[4]),
                      getWeekday(weekDaysVal[5]),
                      getWeekday(weekDaysVal[6])
                    ],
                    lesvaleurs: [
                      weekDays[0],
                      weekDays[1],
            ...
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                return BarChartSample(
                    width: 6,
                    lesX: [
                      extractMonth(monthsVal[5]),
                      extractMonth(monthsVal[4]),
                      extractMonth(monthsVal[3]),
                      extractMonth(monthsVal[2]),
                      extractMonth(monthsVal[1]),
                      extractMonth(monthsVal[0])
                    ],
                    lesvaleurs: [
                      months[5],
                      months[4],
  ...
  Future<List<double>> StpMarche() async {
    ...
    Query ref8 = FirebaseDatabase.instance
        .ref('mails')
        .orderByChild('Time')
        .startAt("${listValHeure[0]}:00")
        .endAt("${listValHeure[0]}:59");
    ...
    if (listHeure.length == 0) {
      listHeure.add(0);
    }
    ;

    Query ref9 = FirebaseDatabase.instance
        .ref('mails')
        .orderByChild('Time')
        .startAt("${listValHeure[1]}:00")
        .endAt("${listValHeure[1]}:59");
    ...
    Query ref10 = FirebaseDatabase.instance
        .ref('mails')
        .orderByChild('Time')
        .startAt("${listValHeure[2]}:00")
        .endAt("${listValHeure[2]}:59");
    ...
    // maListe.add(ten);
    if (listHeure.length == 2) {
      listHeure.add(0);
    }
    ;

    Query ref11 = FirebaseDatabase.instance
        .ref('mails')
        .orderByChild('Time')
        .startAt("${listValHeure[3]}:00")
        .endAt("${listValHeure[3]}:59");
    ...
    if (listHeure.length == 3) {
      listHeure.add(0);
    }
    ;

    Query ref12 = FirebaseDatabase.instance
        .ref('mails')
        .orderByChild('Time')
        .startAt("${listValHeure[4]}:00")
        .endAt("${listValHeure[4]}:59");
    ...
    // maListe.add(twelve);
    if (listHeure.length == 4) {
      listHeure.add(0);
    }
    ;

    Query ref13 = FirebaseDatabase.instance
        .ref('mails')
        .orderByChild('Time')
        .startAt("${listValHeure[5]}:00")
        .endAt("${listValHeure[5]}:59");
  ...
  Future<List<double>> StpMarcheMois() async {
    ...
    Query ref14 = FirebaseDatabase.instance
        .ref('mails')
        .orderByChild('Date')
        .equalTo(weekDaysVal[6]);
  ...
  Future<List<double>> getDataMonth() async {
    ...
    Query ref8 = FirebaseDatabase.instance
        .ref('mails')
        .orderByChild('Date2')
        .startAt("${monthsVal[0]}/01")
        .endAt("${monthsVal[0]}/31");
    ...
    Query ref9 = FirebaseDatabase.instance
        .ref('mails')
        .orderByChild('Date2')
        .startAt("${monthsVal[1]}/01")
        .endAt("${monthsVal[1]}/31");
    ...
    Query ref10 = FirebaseDatabase.instance
        .ref('mails')
        .orderByChild('Date2')
        .startAt("${monthsVal[2]}/01")
        .endAt("${monthsVal[2]}/31");
    ...
    Query ref11 = FirebaseDatabase.instance
        .ref('mails')
        .orderByChild('Date2')
        .startAt("${monthsVal[3]}/01")
        .endAt("${monthsVal[3]}/31");
    ...
    Query ref12 = FirebaseDatabase.instance
        .ref('mails')
        .orderByChild('Date2')
        .startAt("${monthsVal[4]}/01")
        .endAt("${monthsVal[4]}/31");
    ...
    Query ref13 = FirebaseDatabase.instance
        .ref('mails')
        .orderByChild('Date2')
        .startAt("${monthsVal[5]}/01")
        .endAt("${monthsVal[5]}/31");
  ...
  Future<List<double>> getDataYear() async {
    ...
    Query ref8 = FirebaseDatabase.instance
        .ref('mails')
        .orderByChild('Date2')
        .startAt("${yearVal[0]}/01/01")
        .endAt("${yearVal[0]}/12/31");
    ...
    Query ref9 = FirebaseDatabase.instance
        .ref('mails')
        .orderByChild('Date2')
        .startAt("${yearVal[1]}/01/01")
        .endAt("${yearVal[1]}/12/31");
    ...
    Query ref10 = FirebaseDatabase.instance
        .ref('mails')
        .orderByChild('Date2')
        .startAt("${yearVal[2]}/01/01")
        .endAt("${yearVal[2]}/12/31");
    ...
    Query ref11 = FirebaseDatabase.instance
        .ref('mails')
        .orderByChild('Date2')
        .startAt("${yearVal[3]}/01/01")
        .endAt("${yearVal[3]}/12/31");
    ...
    Query ref12 = FirebaseDatabase.instance
        .ref('mails')
        .orderByChild('Date2')
        .startAt("${yearVal[4]}/01/01")
        .endAt("${yearVal[4]}/12/31");
